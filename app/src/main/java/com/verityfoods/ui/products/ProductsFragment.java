    ...
    private void populateProducts() {
        ...
        adapter = new FirestorePagingAdapter<Product, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Product model) {
                ...
                String quantity = holder.total.getText().toString();
                ...
                holder.addToCart.setOnClickListener(view -> {
                    ...
                    int amount = model.getSelling_price() * Integer.parseInt(quantity);
                    ...
                    vars.verityApp.db.collection(Globals.CART)
                            .document(vars.getShoppingID())
                            .set(cart)
                            .addOnSuccessListener(aVoid -> checkExistingProduct(vars.getShoppingID(), model.getUuid(), cartProduct, Integer.parseInt(quantity)));
                });
            }
